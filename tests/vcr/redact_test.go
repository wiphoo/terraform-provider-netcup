...
func TestRedactURLNonRdnsUnchanged(t *testing.T) {
	url := "https://www.servercontrolpanel.de/scp-core/api/v1/servers/100001"
...
func TestMatchInteractionNonRdnsExactOnly(t *testing.T) {
	stored := cassette.Request{Method: "GET", URL: "https://example.com/v1/servers/100001"}
	req := httptest.NewRequest("GET", "https://example.com/v1/servers/100001", nil)
